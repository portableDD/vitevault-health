  ...
  const fetchNotificationCount = useCallback(async () => {
    try {
      ...
      if (res.ok) {
        ...
        const notifs: NotificationPreview[] = (data.notifications || []).map(
          (n: any) => ({
            id: n._id,
            type: n.type,
            title: n.title,
        ...
        setUnreadCount(
          notifs.filter((n: NotificationPreview) => !n.read).length,
        );
      }
    } catch {
      // Silently fail
    ...
    <div className="relative">
      <button
        ...
        className={`relative p-2 rounded-lg transition-colors ${
          mobile ? "hover:bg-gray-100" : "hover:bg-gray-100 text-[#6C757D]"
        }`}
          ...
          <>
            ...
            <motion.div
              ...
              className={`absolute z-50 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden ${
                mobile ? "right-0 top-12 w-80" : "right-0 top-12 w-80"
              }`}
            >
              {/* Header */}
              <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-[#343A40] text-sm">
                    Notifications
                  </h3>
                  {unreadCount > 0 && (
        ...
        >
          ...
          <div className="p-4 border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-[#343A40] text-sm">
                  ...
                  <li key={item.href}>
                    ...
                    >
                      ...
                      {item.icon === "bell" && unreadCount > 0 && (
                        <span
                          className={`ml-auto min-w-5 h-5 rounded-full text-[10px] font-bold flex items-center justify-center px-1 ${
                            isActive
